    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
            ...
            <div class="modal-body">
                     ...
                     <label> Image </label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit_firstname" placeholder="Enter name" required>            
                            </div>
                            <div class="form-group">
                                 
                                <input type="text" class="form-control" id="edit_lastname"  placeholder="Enter lastname">                          
                            </div>    
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="edit_contact"  placeholder="Contact">                          
                            </div>

                            <div class="form-group">
                                
                                <input type="number" class="form-control" id="edit_pagibig"  placeholder="Pag-ibig #">                          
                            </div>

                            <div class="form-group">
                                
                                <input type="number" class="form-control" id="edit_sss"  placeholder="SSS #">                          
                            </div>

                            <div class="form-group">
                                
                                <input type="number" class="form-control" id="edit_philhealth"  placeholder="Philhealth #">                          
                            </div>
                            <div class="form-group">
                                <label for="birthdate" >Birthdate</label>    
                                <input type="date" class="form-control" id="edit_birthdate" placeholder="Address">                          
                            </div>      
                            <div class="form-group">
        ...
        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-success btn-m" id="btn_update">Update</button>
